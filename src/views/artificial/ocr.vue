<template>
  <div class="container">
    ...
    <el-form ref="inputForm" :label-position="labelPosition" label-width="80px">
      <el-form-item label="ocr image">
        <el-upload ref="upload" class="upload-demo" :action="`${this.$main}/intelligent/ocr`" :auto-upload="false" drag :on-success="uploadFileSuccess" limit="1">
