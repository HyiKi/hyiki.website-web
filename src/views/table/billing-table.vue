  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        <el-form-item label="描述" prop="matchDesc">
          <el-input v-model="temp.matchDesc" />
        </el-form-item>
        <el-form-item label="URL" prop="matchUrl">
          <el-input v-model="temp.matchUrl" />
        </el-form-item>
        <el-form-item label="Date" prop="matchDate">
          <el-date-picker v-model="temp.matchDate" type="datetime" placeholder="Please pick a date" />
        </el-form-item>
        <el-form-item label="频道" prop="channel">
          <el-select v-model="temp.channel" class="filter-item" placeholder="Please select">
        ...
        <el-form-item label="选项" prop="optionDesc">
          <el-input v-model="temp.optionDesc" />
        </el-form-item>
        <el-form-item label="赔率" prop="optionOdds">
          <el-input v-model="temp.optionOdds" />
        </el-form-item>
        <el-form-item label="本金" prop="bet">
          <el-input v-model="temp.bet" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      statusOptions: [
        { key: 'pending', display_name: '进行中' },
        { key: 'finish', display_name: '完成' }
      ],
      showReviewer: false,
      temp: {
        id: undefined,
